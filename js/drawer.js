window.onload = function () {
    const figcaption = document.querySelectorAll('.ms-cards__wrapper figure figcaption');
    const details = document.querySelectorAll('.ms-cards__container > .ms-cards__wrapper .ms-card-details');
    
    let isOpen = false;

    figcaption.forEach(e => {
        e.addEventListener('click', function () {
            let itsDeets = this.parentNode.parentNode.querySelector('.ms-card-details');
            if (!isOpen) {
                isOpen = true;
